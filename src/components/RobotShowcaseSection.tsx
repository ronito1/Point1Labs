...
const RobotShowcaseSection = () => {
  ...
  return (
    <section ref={sectionRef} className={cn(
      "w-full py-20 transition-all duration-500",
        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-700">High-precision sensors provide real-time environmental awareness and object recognition.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-700">Continuously learns from interactions to improve performance and personalize responses.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-700">Engineered for natural, human-like movement with high degrees of freedom in all joints.</p>
            </div>
          </div>
        </div>
      </div>
